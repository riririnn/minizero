...
int actor_mcts_tree_max_children = 0;
...
void setConfiguration(ConfigureLoader& cl)
{
    ...
    cl.addParameter("actor_mcts_tree_max_children", actor_mcts_tree_max_children, "cap on per-expansion children used for MCTS node pool sizing; 0 uses the full action size", "Actor");
